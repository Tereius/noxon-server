...
Then copy the `settings.json` from the docker folder and start the application (set for `DNS_HOST_IP` the **ipv4 of your machine**)
...
| dns.hostIp      | DNS_HOST_IP  |                 | The ip of the noxon-server. Only required if the DNS server is enabled                                                                                                                                                                   |
